...
class Main11 {
  ...
  public static void main(String[] args) {
    System.out.println(Day11Solver.getLevelOfMonkeyBusinessPart1(INPUT));
    System.out.println(Day11Solver.getLevelOfMonkeyBusinessPart2(INPUT));
  }
}
