...
class Main3 {
  ...
  public static void main(String[] args) {
    System.out.println(Day3Solver.calculateSumOfPriorities(INPUT));
    System.out.println(Day3Solver.calculateSumOfPrioritiesForGroupsOfThree(INPUT));
  }
}
