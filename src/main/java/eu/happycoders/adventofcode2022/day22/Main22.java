...
class Main22 {
  ...
  private static final CubeLogic CUBE_RULES =
      new CubeLogic(
          50,
          List.of(
              new Wormhole(new WormholeCoordinates(1, UP), new WormholeCoordinates(9, LEFT)),
              new Wormhole(new WormholeCoordinates(1, LEFT), new WormholeCoordinates(6, LEFT)),
              new Wormhole(new WormholeCoordinates(2, UP), new WormholeCoordinates(9, DOWN)),
              new Wormhole(new WormholeCoordinates(2, RIGHT), new WormholeCoordinates(7, RIGHT)),
              new Wormhole(new WormholeCoordinates(2, DOWN), new WormholeCoordinates(4, RIGHT)),
              new Wormhole(new WormholeCoordinates(4, LEFT), new WormholeCoordinates(6, UP)),
              new Wormhole(new WormholeCoordinates(7, DOWN), new WormholeCoordinates(9, RIGHT)),
              new Wormhole(new WormholeCoordinates(5, UP), new WormholeCoordinates(6, RIGHT))));

  public static void main(String[] args) {
    System.out.println(Day22Solver.solveTask1(INPUT));
    System.out.println(Day22Solver.solveTask2(INPUT, CUBE_RULES));
  }
}
